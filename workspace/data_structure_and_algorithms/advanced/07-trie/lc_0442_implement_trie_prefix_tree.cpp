...
int main() {
    ...
    std::cout << (false == trie.search("code")) << std::endl;
    std::cout << (true == trie.startsWith("lint")) << std::endl;
    std::cout << (false == trie.startsWith("linterror")) << std::endl;
    trie.insert("linterror");
    std::cout << (true == trie.search("lintcode")) << std::endl;
    std::cout << (true == trie.startsWith("linterror")) << std::endl;
